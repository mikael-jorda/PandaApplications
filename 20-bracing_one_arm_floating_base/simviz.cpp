...
// - read
const string TORQUES_COMMANDED_KEY  = "sai2::PandaApplication::actuators::fgc";
...
int main() {
	...
	cout << "T base robot pos : " << T_world_robot.translation().transpose() << endl;
	cout << "T base robot rot : " << T_world_robot.linear() << endl;
