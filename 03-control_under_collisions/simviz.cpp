...
const string world_file = "../resources/03-control_under_collisions/world.urdf";
const string robot_file = "../resources/03-control_under_collisions/panda_arm_hand.urdf";
