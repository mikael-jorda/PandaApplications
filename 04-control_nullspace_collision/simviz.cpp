...
const string world_file = "../resources/04-control_nullspace_collision/world.urdf";
const string robot_file = "../resources/04-control_nullspace_collision/panda_arm_hand.urdf";
