...
// redis keys:
const string ROBOT_POS_KEY = "sai2::PandaApplications::18::simviz_panda::sensors::sphere_pos";
const string ROBOT_VEL_KEY = "sai2::PandaApplications::18::simviz_panda::sensors::sphere_vel";
const string ROBOT_COMMAND_TORQUES_KEY = "sai2::PandaApplications::18::simviz_panda::actuators::command_torques";

const string ROBOT_SENSED_FORCE_KEY = "sai2::PandaApplications::18::simviz_panda::sensors::sensed_force";
...
int main() {
	...
	const Vector3d center_graphic_representation = Vector3d(0.0,-0.5,0.8);
