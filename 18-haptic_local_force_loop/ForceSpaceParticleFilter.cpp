...
void ForceSpaceParticleFilter::resamplingLowVariance(vector<pair<Vector3d, double>> weighted_particles)
{
...
void ForceSpaceParticleFilter::computePCA(Vector3d& eigenvalues, Matrix3d& eigenvectors)
{
